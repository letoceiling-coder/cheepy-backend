...
class ParserSetting extends Model
{
    protected $fillable = [
        ...
        'download_medium',
        'update_existing',
        'incremental_tail_pages',
        'update_availability_only',
    ...
    protected $casts = [
        ...
        'incremental_tail_pages' => 'integer',
    ...
    public static function defaults(): array
    {
        return [
            ...
            'workers_photos' => 1,
            'proxy_enabled' => true,
            'proxy_url' => 'http://85.198.64.93:3128',
            'proxy_urls' => [
                'http://85.198.64.93:3128',
                'http://155.212.223.238:3128',
